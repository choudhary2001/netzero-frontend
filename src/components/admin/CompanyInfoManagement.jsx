...
const dummyCompanies = [
    { id: 1, name: 'Eco Corp', regNumber: 'RN12345', submitted: '2024-07-15', status: 'Pending' },
    { id: 2, name: 'Green Solutions Ltd.', regNumber: 'RN67890', submitted: '2024-07-14', status: 'Approved' },
    { id: 3, name: 'Sustainable Inc.', regNumber: 'RN11223', submitted: '2024-07-12', status: 'Rejected' },
    { id: 4, name: 'Planet Protectors', regNumber: 'RN44556', submitted: '2024-07-11', status: 'Pending' },
];
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                        {dummyCompanies.map((company) => (
                            <tr key={company.id}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{company.regNumber}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{company.submitted}</td>
